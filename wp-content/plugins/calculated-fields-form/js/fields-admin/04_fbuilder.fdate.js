			...
			editItemEvents:function()
				{
					var evt = [
							...
							{s:"#sMinHour",e:"keyup", l:"minHour"},
							{s:"#sMaxHour",e:"keyup", l:"maxHour"},
							{s:"#sMinMinute",e:"keyup", l:"minMinute"},
							{s:"#sMaxMinute",e:"keyup", l:"maxMinute"},
							{s:"#sStepHour",e:"keyup", l:"stepHour"},
							{s:"#sStepMinute",e:"keyup", l:"stepMinute"},
							{s:"#sDefaultTime",e:"keyup", l:"defaultTime"}
						];
