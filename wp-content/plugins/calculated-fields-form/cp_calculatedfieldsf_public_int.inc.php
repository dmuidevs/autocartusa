...
if( !empty( $form_data ) )	
{
	...
	{	
		...
		if( isset( $templatelist[ $form_data[ 1 ][ 0 ]->formtemplate ] ) )
		{
			...
			print '<link href="'.esc_attr( esc_url( $templatelist[ $form_data[ 1 ][ 0 ]->formtemplate ][ 'file' ] ) ).'?ver=pro" type="text/css" rel="stylesheet" property="stylesheet" />';
